...
**Note: Please understand that IMDb does not allow scraping of web pages. I have created this package for my own personal learning. Do NOT use this in production. I am not responsible for any issues that you run into.**
...
```json
{
  ...
  "jobTitles": ["Actor", "Soundtrack", "Producer"],
  "height": 1.83,
  "filmography": [
    {
      "title": "Actor",
